 ...
 'createNode': function($node, data) {
	...
	frappe.call({
		...
		var secondMenu;			
			...
			$node.find('.content').append(secondMenu);
}
		});
...
//console.log($node);
	...
	frappe.confirm(__('Are you sure you want to change the department of the Employee? GO TO '+'<a href="#Form/Employee/'+dragged1+'">'+dragged1+'</a>'+' page'), function () {
	frappe.call({
...
//console.log(level);
	...
	frappe.confirm(__('Are you sure you want to delete '+node+' from the chart?'), function () {
