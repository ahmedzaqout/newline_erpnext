...
frappe.pages['hr-structurecopy'].on_page_load = function(wrapper) {
...
//console.log($node);
	...
	function () {msgprint("test");return false;});
    });
...
var d = new frappe.ui.Dialog({
    'fields': [
        {'fieldname': 'node_name','label':__('New Node Name'), 'fieldtype': 'Data'},
        {'fieldname': 'node_type','label':__('Type'), 'fieldtype': 'Link','options':'HR Structure Type'},
        {'fieldname': 'director','label':__('Director'), 'fieldtype': 'Link','options':'Employee'},
        {'fieldname': 'director_name','label':__('Director Name'), 'fieldtype': 'Data'},
        {'fieldname': 'node_parent','label':__('Parent'), 'fieldtype': 'Link','options':'HR Structure'},
    ],
...
d.fields_dict.director_name.$input.val("Test");
d.show();
