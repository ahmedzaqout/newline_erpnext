...
def get_leave_balance_on(employee, leave_type, date, allocation_records=None,
	...
	total_hrs , disc_hours ,total_real_hrs, compensatory_total_hours, permission_total_hours = get_working_total_hours(employee,allocation.from_date, date)
	...
	if com == "Nawa":
		...
		if leave_type == _('Sick Leave'):
			disc_hours =disc_hours - sick_ex_total_hours
