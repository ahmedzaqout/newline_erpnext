...
doctype_js = {
 ...
 # "Employee" :"public/js/jquery.steps_1.1.0/jquery.steps.min.js",
	#"Employee" :"public/js/jquery.steps_1.1.0/jquery.steps.js",
}
...
notification_config = "erpnext.startup.notifications.get_notification_config_hr"
...
permission_query_conditions = {
	"Employee Evaluation": "erpnext.hr.doctype.employee_evaluation.employee_evaluation.get_permission_query_conditions",
}
...
doc_events = {
	...
	'Holiday List': {
		'on_update': 'erpnext.hr.doctype.attendance.attendance.onholiday'
		#"validate": "erpnext.hr.doctype.attendance.attendance.onholiday"
	},
	'job Applicant': {
		'after_insert': 'erpnext.hr.doctype.job_applicant.job_applicant.send_email'
		#"validate": "erpnext.hr.doctype.attendance.attendance.onholiday"
	}
}
...
scheduler_events = {
	"monthly":[
		'erpnext.hr.doctype.finger_print_device_control_panel.finger_print_device_control_panel.clear_attendance',
	],
	"hourly": [
		...
		#"erpnext.hr.doctype.finger_print_device_control_panel.finger_print_device_control_panel.add_attendances",update_att
		'erpnext.hr.doctype.finger_print_device_control_panel.finger_print_device_control_panel.upload_attendance',
            	'erpnext.hr.doctype.attendance.attendance.check_attendance'
		#'erpnext.hr.doctype.finger_print_device_control_panel.finger_print_device_control_panel.zk_upload_attendance'
	...
	"daily": [
		...
		#"erpnext.assets.doctype.asset.asset.update_maintenance_status",
            	#"erpnext.hr.doctype.employee.employee.update_shifts",
		#"erpnext.hr.doctype.attendance.attendance.update_holiday",
		'erpnext.hr.utils.notify_manpower_planning_date',
		'erpnext.hr.notify_retirement_employee',
		'erpnext.hr.notify_trial_employee',
		'erpnext.hr.notify_for_evaluation',
		'erpnext.hr.notify_manpower_jobopening_date',
		'erpnext.hr.notify_6month_employee'
	...
	#"all": [
    	#	"erpnext.hr.doctype.finger_print_device_control_panel.finger_print_device_control_panel.zk_exec"
	#],

	"cron": {
		 "*/1 * * * *": [
		'erpnext.hr.hide_expired_job_opening', 
       		 ],
        	"*/30 18-23 * * *": [
            		"erpnext.hr.doctype.attendance.attendance.check_attendance"
			#"erpnext.hr.doctype.attendance.attendance.update_holiday"
		...
		#"30 12 * * *": [
            	#	"erpnext.hr.doctype.warning_information.warning_information.check_employee_task"
       		 #],
        	"0 */4 * * *": [
       		 ],
        	"45 9 * * *": [
        	...
        	"45 18 * * *": [
			'erpnext.hr.exit_perm'
       		 ],
		"annual": [
			"erpnext.hr.page.payroll_report.payroll_report.ann_inc_experience_years",
			"erpnext.hr.page.payroll_report.payroll_report.annually_increase_payroll"
		]
