...
def install(country=None):
	records = [
		...
		{'doctype': 'Salary Component', 'salary_component': _('Premium nature work'), 'description': _('PNW'), 'type': 'Earning'},
		{'doctype': 'Salary Component', 'salary_component': _('Bonus Wife'), 'description': _('BW'), 'type': 'Earning'},
		{'doctype': 'Salary Component', 'salary_component': _('Bonus Children'), 'description': _('BCH'), 'type': 'Earning'},
		...
		# Violation type
		{'doctype': 'Violation Type', 'name': _('Employee Task Report'), 'violation_type': _('Employee Task Report')},
		{'doctype': 'Violation Type', 'name': _('Morning Late'), 'violation_type': _('Morning Late')},
		...
		{'doctype': 'Employment Type', 'employee_type_name': _('Trial')},
